...
class Span:
    ...
    def union(self, *others: Iterable[Span]) -> Span: ...
    def union_update(self, *others: Iterable[Span]) -> None: ...
...
class Interval:
    ...
    def union(self, *others: Iterable[Interval]) -> Interval: ...
    def union_update(self, *others: Iterable[Interval]) -> None: ...
